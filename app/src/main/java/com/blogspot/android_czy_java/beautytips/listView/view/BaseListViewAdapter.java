...
public abstract class BaseListViewAdapter<ITEM_MODEL extends ItemModelInterface>
        extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int CONST_HEIGHT = 1920;
    private static final int CONST_HEIGHT_LAND = 1080;
    ...
    int[] itemHeightsInDp = {630, 670, 640, 600, 670, 630, 640, 600};
    ...
    BaseListViewAdapter(Context context, List<ITEM_MODEL> list, PositionListener
    ...
    */
    public interface PositionListener {
        void onClickDeleteTip(Long tipId);
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder h, int position) {
        ...
        //fill in normal list item
            ...
            final ITEM_MODEL item = list.get(position - 1);
