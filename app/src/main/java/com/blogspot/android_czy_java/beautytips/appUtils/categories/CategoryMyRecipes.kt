...
enum class CategoryMyRecipes(override val subcategory: SubcategoryLabel) : CategoryInterface {

    SUBCATEGORY_ALL(SubcategoryLabel.SUBCATEGORY_ALL);

    override fun getCategoryLabel() = CategoryLabel.CATEGORY_MY_RECIPES.label
